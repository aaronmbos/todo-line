...
class ArgParser:
    ...
    def add_all_subparsers(self, parser):
        ...
        add_cmd.add_argument('-s', '--sub', type=int, default='-1')
        ...
        check_cmd.add_argument('-s', '--sub', type=int, default='-1')
        ...
        uncheck_cmd.add_argument('-s', '--sub', type=int, default='-1')
        ...
        delete_cmd.add_argument('-s', '--sub', type=int, default=-1)
